...
SYSTEM = (
    f"Si ya conoces el nombre del usuario, utilízalo siempre en tus respuestas, si no no respondas."
    ...
    f"El número de contacto, y para pago, o yapeo (pago por yape) es: +51 952 123 456. "
